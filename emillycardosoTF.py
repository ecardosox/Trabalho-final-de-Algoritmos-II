...
if comando == arqu_total:
    ...
    if comando_ssounn == sim: # se o usuario digitar SIM, irá aparecer tudo o que está indentado
        ...
        arquivo = pd.read_csv('dengue.csv')
        area = arquivo['Status']
        total_posi = 'POSITIVO'
...
#------------------------------------------------------------------------------------------------------------------------------------')
        ...
        arq = pd.read_csv('dengue.csv')
        print('Para saber a quantidade de casos positivos ou negativos entre os dias 09/01/2017 até 08/11/2017: ')

        posi_nega = input('Digite POSITIVO ou NEGATIVO: ').upper()
        data = input('Digite o dia (entre 09/01/2017 até 08/11/2017): ')
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if dia_citado not in [sim, nao]:
            print('Número digitado incorreto, tente novamente!')


#ARQUIVO COM 500 LINHAS ABAIXO
...
if comando == arq_500:
    ...
    if comando_ssounn == nao:
        print('A análise terminou!')
    if comando_ssounn == sim: # se o usuario digitar irá aparecer tudo o que está indentado
...
#------------------------------------------------------------------------------------------------------------------------------------')
        ...
        arq = pd.read_csv('dengue500.csv')
        print('Para saber a quantidade de casos positivos ou negativos entre os dias 09/01/2017 até 11/01/2017: ')

        posi_nega = input('Digite POSITIVO ou NEGATIVO: ').upper() #colocar upper para ficar em maiusculo
